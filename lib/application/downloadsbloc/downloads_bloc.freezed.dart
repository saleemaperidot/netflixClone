...
mixin _$DownloadsState {
  ...
  List<downloadModel> get downloadImage => throw _privateConstructorUsedError;
  Option<Either<MainFailure, List<downloadModel>>>
      get failureorsuccesdownloads => throw _privateConstructorUsedError;
...
abstract class $DownloadsStateCopyWith<$Res> {
  ...
  $Res call(
      {bool isLoading,
      List<downloadModel> downloadImage,
      Option<Either<MainFailure, List<downloadModel>>>
...
class _$DownloadsStateCopyWithImpl<$Res, $Val extends DownloadsState>
  ...
  $Res call({
    ...
    Object? downloadImage = null,
    Object? failureorsuccesdownloads = null,
  }) {
    return _then(_value.copyWith(
      isLoading: null == isLoading
          ...
          : isLoading // ignore: cast_nullable_to_non_nullable
              as bool,
      downloadImage: null == downloadImage
          ? _value.downloadImage
          : downloadImage // ignore: cast_nullable_to_non_nullable
              as List<downloadModel>,
      failureorsuccesdownloads: null == failureorsuccesdownloads
          ? _value.failureorsuccesdownloads
          : failureorsuccesdownloads // ignore: cast_nullable_to_non_nullable
...
class _$_DownloadsState implements _DownloadsState {
  const _$_DownloadsState(
      ...
      required final List<downloadModel> downloadImage,
      required this.failureorsuccesdownloads})
      : _downloadImage = downloadImage;

  @override
  final bool isLoading;
  final List<downloadModel> _downloadImage;
  @override
  List<downloadModel> get downloadImage {
    if (_downloadImage is EqualUnmodifiableListView) return _downloadImage;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_downloadImage);
  }

  @override
  final Option<Either<MainFailure, List<downloadModel>>>
      failureorsuccesdownloads;

  @override
  String toString() {
    return 'DownloadsState(isLoading: $isLoading, downloadImage: $downloadImage, failureorsuccesdownloads: $failureorsuccesdownloads)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._downloadImage, _downloadImage) &&
            (identical(
                    other.failureorsuccesdownloads, failureorsuccesdownloads) ||
                other.failureorsuccesdownloads == failureorsuccesdownloads));
  }
  ...
  int get hashCode => Object.hash(
      runtimeType,
      isLoading,
      const DeepCollectionEquality().hash(_downloadImage),
      failureorsuccesdownloads);
...
abstract class _DownloadsState implements DownloadsState {
  const factory _DownloadsState(
      ...
      required final Option<Either<MainFailure, List<downloadModel>>>
          failureorsuccesdownloads}) = _$_DownloadsState;
  ...
  List<downloadModel> get downloadImage;
  @override
  Option<Either<MainFailure, List<downloadModel>>> get failureorsuccesdownloads;
  @override
  @JsonKey(ignore: true)
  _$$_DownloadsStateCopyWith<_$_DownloadsState> get copyWith =>
      throw _privateConstructorUsedError;
